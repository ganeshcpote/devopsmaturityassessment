	...
	<div class="col-xl-9 col-lg-11 m-2 pb-4 rounded text-center text-light mx-auto">
			...
			<section class="jumbotron text-center bg-dark border-primary border">
				<div class="container">
					...
					<p>
						...
						<a href="https://github.com/ganeshcpote/devopsmaturityassessment" target="_blank" class="btn btn-secondary">Fork us on GitHub</a>
					</p>
				</div>
			</section>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="text-justify">This tool is made available under the MIT License: you are free to use, adapt and redistribute it, both for commercial and non-commercial use. There is no obligation to share your changes, although we always appreciate feedback! Why not <a href="https://github.com/ganeshcpote/devopsmaturityassessment" target="_blank">fork us on GitHub</a>?</p>
